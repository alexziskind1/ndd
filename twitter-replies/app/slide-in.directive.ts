...
export class SlideInDirective {
    ...
    public show(): void {
        //This is the height of the replies panel, which should be calculated properly, but we're faking it here.
        const repliesPanelHeight = this.getTranslateYHeight() / 2 - 30;
        this.element.nativeElement.animate({
            translate: { x: 0, y: repliesPanelHeight * -1 },
